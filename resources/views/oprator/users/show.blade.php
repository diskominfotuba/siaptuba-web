                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset('storage/users/img/face' . $pegawai->photo) }}" alt="user-avatar"
                        ...
                        <form id="formAccountSettings" onsubmit="return false">
                            ...
                            <div class="row g-2 mt-1">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input name="opd_id" type="text" id="organisasi" class="form-control"
                                        value="{{ $pegawai->opd->nama_opd }}" readonly />
                                </div>
                            </div>
                            <div class="row g-2 mt-1">
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <select class="form-select" name="tpp" aria-label="status">
                                        ...
                                        <option value="non_asn"
                                            {{ $pegawai->status_pegawai == 'non_asn' ? 'selected' : '' }}>NON ASN</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-6 mt-3">
                                    <label for="nominal" class="form-label">Tambahan Penghasilan Pegawai (TPP)</label>
                                    <div class="input-group mb-2">
                                        <input type="text" name="tpp" value="{{ formatRp($pegawai->tpp) }}"
                                            class="form-control" id="nominal" placeholder="Masukan nominal"
                                            onkeyup="formatRupiah(this)">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-2">
                                <button id="btn_loading_update" class="btn_loading btn btn-primary d-none" type="button"
                                    disabled>
                                    <span class="spinner-border spinner-border-sm" role="status"
                                        aria-hidden="true"></span>
                                    Loading...
                                </button>
                                <button id="btn_update" type="submit" class="btn btn-primary me-2">Simpan
                                    Perubahan</button>
                            </div>
                        </form>
                    </div>
                ...
                <div id="notif" class="card mb-3 bg-primary d-none">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center" role="alert">
                            <svg class="bi flex-shrink-0 me-2" style="color: #fff" width="24" height="24"
...
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAD8y5ZQcuol7vxOkXii_wsHqYhCNL0uEM&libraries=geometry&callback">
    ...
    <script type="text/javascript">
        ...
        $('#export').click(function() {
            ...
            window.location.href = '/oprator/presensi/pegawai/export?user_id=' + user_id + '&tanggal_awal=' +
