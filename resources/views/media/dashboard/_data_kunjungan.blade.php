...
<a href="javascript:void()" onclick="showKegiatan({{ $item }})" data-toggle="modal" data-target="#showKegiatanModal" class="item">
    <div class="detail">
        <div>
            <strong>{{ $item->kegiatan->nama_kegiatan }}</strong>
            <p>{{ $item->kegiatan->deskripsi_kegiatan }}</p>
            <span class="badge badge-primary mt-1">Hadir</span>
        </div>
    </div>
</a>
@empty
