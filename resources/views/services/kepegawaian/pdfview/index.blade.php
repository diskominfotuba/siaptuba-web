...
@section('content')
        ...
        <div class="section mt-2" style="height: 75vh; overflow: hidden;">
            <div class="splash-page" style="height: 100%; display: flex; justify-content: center; align-items: center;">
                ...
                <iframe id="pdf-viewer"
                    src="https://docs.google.com/gview?embedded=true&url=http://127.0.0.1:8000/{{ Illuminate\Support\Facades\Storage::url($url) }}"
    ...
    <div class="form-button-group transparent">
        ...
        <a id="btn_refresh" href="{{ url()->current() }}" class="btn-submit btn btn-primary btn-block btn-lg d-none">Refresh
            halaman</a>
    </div>
@endsection
@push('js')
