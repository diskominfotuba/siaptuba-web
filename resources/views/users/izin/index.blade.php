                        ...
                        <form id="tambahIzin" autocomplete="off">
                            ...
                            <div class="form-group rounded">
                                <div class="input-wrapper">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="cutystart" name="tanggal_awal"
                            ...
                            <div class="form-group rounded">
                                <div class="input-wrapper">
                                    ...
                                    <div class="input-group">
                                        <input type="date" class="form-control" id="cutyend" name="tanggal_akhir"
                                            placeholder="Pilh" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group rounded">
