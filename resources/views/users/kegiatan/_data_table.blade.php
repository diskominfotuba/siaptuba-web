@forelse ($table as $tb)
<div class="goals mb-1" onclick="showKegiatan({{ $tb }})" data-toggle="modal" data-target="#showKegiatan">
    <div class="item">
        <div class="in">
            <div>
                <h4>{{ $tb->kegiatan->nama_kegiatan }}</h4>
                <p>{{ $tb->kegiatan->deskripsi_kegiatan }}</p>
