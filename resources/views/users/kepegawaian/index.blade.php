...
<div class="container mt-3" style="padding-bottom: 20px">
    <div style="padding-top: 50px">
        ...
        <div class="row">
            <div class="col-6 col-md-6">
                <a href="/cek_top">
                    <div class="card mb-2 text-center">
                        <img src="{{ asset('assets/icon/2666435.png') }}" alt="icon" width="100%" class="p-4">
                        <h3>Dokumen</h3>
                    </div>
                </a>
            </div>
            <div class="col-6 col-md-6">
                <div class="card mb-2 text-center">
                    <img src="{{ asset('assets/icon/Share_doc-512.webp') }}" alt="icon" width="100%" class="p-3">
                   <h3>Pengajuan</h3>
                </div>
            </div>
        </div>
        <div class="section-title h3">Riwayat pengajuan</div>
        <div class="card">
            <div class="card-body">
