...
<div class="card mb-2">
    <div class="card-body">
        <table class="table table-responsive">
            <tbody>
              <tr>
                <td><strong>Tgl:</strong> <span class="text-primary">{{ \Carbon\Carbon::parse($tb->created_at)->isoFormat('dddd, D MMMM YYYY') }}</span></td>
            </tr>
            <tr>
                <td><strong>Keterangan:</strong> <span class="text-primary">{{ $tb->jumlah_menit }}</span></td>
            </tr>
            <tr>
                <td><strong>Pengurangan:</strong> <span class="text-primary">{{ formatRp($tb->pengurangan) }}</span></td>
            </tr>
            </tbody>
        </table>
    </div>
