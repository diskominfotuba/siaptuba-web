...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="javascript:void()" id="pengajuanDiproses">
                    <div class="card mb-3">
                        <div class="row g-0 align-items-center">
                            <div class="card-body">
                                <label for="" style="color: #566a7f">Pengajuan diproses</label>
                                <h4 class="card-text fw-bold">
                                    {{ $pengajuan_diproses }}
                                </h4>
                            </div>
            ...
            <div class="col-md-3">
                <a href="javascript:void()" id="pengajuanSelesai">
                    <div class="card mb-3">
                        <div class="row g-0 align-items-center">
                            <div class="card-body">
                                <label for="" style="color: #566a7f">Pengajuan selesai</label>
                                <h4 class="card-text fw-bold">
                                    {{ $pengajuan_diterima }}
                                </h4>
                            </div>
...
@push('js')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#pengajuanDiproses').click(function() {
                filterTable('diproses');
            });

            $('#pengajuanSelesai').click(function() {
                filterTable('selesai');
            });

            $('#pengajuanDitolak').click(function() {
                filterTable('ditolak bkpp');
            });
        });
