<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-uppercase">{{ $tb->user->nama }}</td>
            <td>{{ $tb->user->nip }}</td>
            <td>
                <a href="{{ route('stream', ['filename' => 'dokumen_kepegawaian|berkala|'.$tb->file]) }}" target="_blank" class="badge bg-info"><i class='bx bxs-file-pdf'></i></a>
            </td>
            <td>
                <span onclick="hapusBerkala('{{ $tb->id }}')" class="badge bg-danger"><i class='bx bx-x-circle'></i></span>
            </td>
        </tr>
        @empty
        <tr>
