    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light"><a href="{{ route('bkpp.master.kategori') }}">Kategori Layanan</a> /</span>
            ...
            <div class="row mb-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="formSubmit">
                                ...
                                <div class="row g-2">
                                    <div class="col mb-3">
                                        ...
                                        <input type="text" id="nama_layanan" name="nama_layanan"
                                            placeholder="Kenaikan Pangkat Fungsional" class="form-control">
                                    </div>
                                </div>
                                ...
                                <button id="btnSubmit" type="submit" class="btn btn-primary">Tambah Layanan</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8 mb-4 mb-md-0">
                    <div class="card">
                        <h5 class="card-header">Layanan {{ $kategori->nama_kategori }}</h5>
                        <div class="card-body">
...
@push('js')
    ...
    <script>
        ...
        $("#formSubmit").submit(async function(e) {
            ...
            if (id_kategori) {
                var _url = '/bkpp/kepegawaian/show/' + {{ $kategori->id }} + '/update/' + id_kategori;
            } else {
                var _url = '/bkpp/kepegawaian/show/' + {{ $kategori->id }} + '/store';
            }
        ...
        // updateKategori
        function updateKategori(id, nama_layanan) {
            id_kategori = id;
        ...
        async function hapusKategori(id) {
            ...
            if (willDelete) {
                let param = {
                    url: '/bkpp/kepegawaian/show/' + {{ $kategori->id }} + '/destroy/' + id,
                    method: "POST",
                    processData: false,
                    contentType: false,
                    cache: false,
