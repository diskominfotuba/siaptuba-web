    ...
    <tbody>
        @forelse ($table as $key => $tb)
            <tr>
                ...
                <td class="nama">{{ $tb->nama_kategori }}</td>
                <td>
                    <a href="{{ route('bkpp.master.layanan', $tb->id) }}" class="btn btn-primary btn-sm">Lihat Layanan</a>
                    <button class="btn btn-sm btn-warning"
                        onclick="updateKategori('{{ $tb->id }}', '{{ $tb->nama_kategori }}')">edit</button>
