    ...
    <script type="text/javascript">
        ...
        function openCamera(status, lat, long) {
            ...
            function setCamera() {
                ...
                // Definisikan constraints terlebih dahulu
                const constraints = {
                    video: {
                        width: 490,
                        height: 450,
                        // Jika ada kamera yang ingin dipilih berdasarkan sourceId
                        deviceId: cameras[0] ? { exact: cameras[0] } : undefined
                    }
                };

                // Inisialisasi Webcam.js dengan constraints
                Webcam.set({
                    width: 490,
                    height: 450,
                    image_format: 'jpeg',
                ...
                document.querySelector('.webcam-capture video').setAttribute('id', 'myVideo');
                faceRecognation();
                ...
                .then(function(stream) {
                    // Menetapkan stream sebagai sumber untuk videoElement
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (
                ...
                navigator.mediaDevices
                    ...
                    .then(function (stream) {
                        const video =
                        document.querySelector("#videoElement video");
                        video.srcObject = stream;
                        video.play();
                        video.addEventListener("loadedmetadata", onPlay);
